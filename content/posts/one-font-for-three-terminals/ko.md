...
합쳐진 폰트의 글리프는 54,587자입니다. 빌드는 제 맥에서 6분쯤 걸렸는데, 정밀하게 잰 값은 아니고 체감입니다.
...
대가가 하나 있습니다. 700은 더 이상 Menlo가 그린 Bold가 아니라 그보다 한 칸 굵은 합성입니다. 터미널의 ANSI 볼드는 기본적으로 700을 쓰니 볼드가 원본보다 굵어집니다. 원본 Bold를 볼드로 쓰려면 앱의 볼드 웨이트를 600으로 내리면 됩니다. Orca는 `Bold Font Weight`, VSCode는 `terminal.integrated.fontWeightBold`입니다.
